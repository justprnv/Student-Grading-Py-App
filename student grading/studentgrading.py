# Full version of Student Grading App with:
# ✅ Dropdowns for Class and Student selection
# ✅ Assignment + Grades per Class
# ✅ GPA + Letter Grade Calculation
# ✅ CSV Export (Class & All Data)
# ✅ Universal Home/Back buttons
# ✅ Real-time Logs
# ✅ Show all grades in selected class
...
class StudentGradingApp:
    ...
    def add_class(self):
        class_id = simpledialog.askstring("Class ID", "Enter class ID (e.g., CS101):")
